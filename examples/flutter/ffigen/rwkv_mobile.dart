...
class rwkv_mobile {
  ...
  late final _rwkvmobile_runtime_get_available_backend_namesPtr = _lookup<
      ...
      'rwkvmobile_runtime_get_available_backend_names');
  late final _rwkvmobile_runtime_get_available_backend_names =
      _rwkvmobile_runtime_get_available_backend_namesPtr
  ...
  late final _rwkvmobile_runtime_init_with_name_extra =
      _rwkvmobile_runtime_init_with_name_extraPtr.asFunction<
          rwkvmobile_runtime_t Function(
              ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Void>)>();
  ...
  late final _rwkvmobile_runtime_eval_chat_with_historyPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ...
              ffi.Pointer<
                  ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>)>>,
              ffi.Int)>>('rwkvmobile_runtime_eval_chat_with_history');
  ...
  late final _rwkvmobile_runtime_get_avg_decode_speedPtr =
      _lookup<ffi.NativeFunction<ffi.Double Function(rwkvmobile_runtime_t)>>(
          'rwkvmobile_runtime_get_avg_decode_speed');
  late final _rwkvmobile_runtime_get_avg_decode_speed =
      _rwkvmobile_runtime_get_avg_decode_speedPtr
  ...
  late final _rwkvmobile_runtime_get_avg_prefill_speedPtr =
      _lookup<ffi.NativeFunction<ffi.Double Function(rwkvmobile_runtime_t)>>(
